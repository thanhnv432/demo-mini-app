  ...
  return (
    <div style={{ marginInline: 50 }}>
      <Card title="Text Here">
        <TextArea value={value} onChange={setValue} showCount maxLength={100} placeholder="Enter your content..." />
      </Card>

      <Space direction="vertical" style={{ "--gap": "24px", marginBottom: "24px" }}>
        <Button size="middle" color="primary" fill="solid" text="Middle Button" onClick={() => console.log(3)} />
      </Space>
      <ModalComp />
